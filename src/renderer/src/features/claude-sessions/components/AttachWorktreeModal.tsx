...
// `LabeledInput` and `ColorPicker` used to live inline here ("no reuse
// case yet") — they moved to `design/FormControls.tsx` when
// `AddToGroupModal` became the second consumer.
